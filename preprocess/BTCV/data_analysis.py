...
for case in os.listdir(btcv_lbl_path):
    ...
    # spacing
    lbl_spacing = [int(i*1000+0.5)/1000 for i in vol.GetSpacing()]
    img_spacing = [int(i*1000+0.5)/1000 for i in vol1.GetSpacing()]
    assert lbl_spacing == img_spacing
    spacing_list.append(lbl_spacing)
...
print(np.median(spacing_list, axis=0))
...
######################################################
# 30个CT中各器官的个数：{1: 30, 2: 30, 3: 30, 4: 28, 5: 30, 6: 30, 7: 30, 8: 30, 9: 30, 10: 30, 11: 30, 12: 30, 13: 30}
# 器官平均体积：# {1: 150205.6, 2: 73771.76666666666, 3: 74399.06666666667, 4: 12981.17857142857, 5: 7322.133333333333,
# # 6: 798498.6666666666, 7: 203866.7, 8: 45466.4, 9: 41663.6, 10: 16301.066666666668, 11: 38546.666666666664,
# # 12: 1973.9333333333334, 13: 2453.6}
# 器官体积比例：# {1: 5.316037928457172, 2: 10.823905983906219, 3: 10.732643599471677, 4: 61.51203161353571, 5: 109.05273508631365,
# # 6: 1.0, 7: 3.9167684897370028, 8: 17.562390395251583, 9: 19.165378571862888, 10: 48.98444273585368,
# # 11: 20.71511587685922, 12: 404.52159816272075, 13: 325.4396261275948}
######################################################
