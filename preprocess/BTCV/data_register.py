...
# ###########################Input_Images######################################
# =============================================================================
fixed_image = sitk.ReadImage(r'D:\Projects\OrgansSegment\SegWithPatch\samples\Training\img\img0009.nii.gz', sitk.sitkInt16)
moving_image = sitk.ReadImage(r'D:\Projects\OrgansSegment\SegWithPatch\samples\Training\img\img0001.nii.gz', sitk.sitkInt16)
##Name the Image
Registered_imageName = '1-to-9'
...
registration_method.SetOptimizerAsGradientDescent(learningRate=1.0, numberOfIterations=9, convergenceMinimumValue=1e-6,
