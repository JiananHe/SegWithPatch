...
def load_dataset_path():
    """
    load the paths of image and segmentation
...
class DummyDL(SlimDataLoaderBase):
    def __init__(self, num_threads_in_mt=8):
        super(DummyDL, self).__init__(None, None, None)
    ...
    def generate_train_batch(self):
        print("# thread: ", self.number_of_threads_in_multithreaded, "thread id: ", self.thread_id)
...
if __name__ == "__main__":
    ...
    #     batches.append(i)
    # print(batches)
    # assert len(np.unique(batches)) == 10 and len(batches) == 10
    #
    # batches = []
    # for i in mt:
    #     batches.append(i)
